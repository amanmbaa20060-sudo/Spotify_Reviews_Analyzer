...
_Generated: 2026-06-21T12:06:54.812949+00:00_
...
- `rq1.search.browse_friction` — Search/browse friction (73)
- `rq1.overwhelm.choice_overload` — Choice overload / too many options (25)
- `rq1.onboarding.discovery_features` — Poor onboarding to discovery features (11)
- `rq1.entry_points.clarity` — Discovery entry points are unclear (10)
...
**rq1.search.browse_friction**
- `c770585c-b957-41e2-9c16-423fd0fe6293` (app_store, negative): "Probably the worst music app ever. Kept signing me out of my account and the link to log back in kept glitching like crazy. It wouldn’t even go through. And this happens ALL THE TIME. Sometimes it takes over 3 hours just to log back in if it will ..."
- `b022b40d-0850-4bb3-8940-ffd1cfd07d3c` (mastodon, positive): "Ein selbst gebauter KI-DJ für mein Blog Bei meinem Arbeitgeber bekam ich es mit einem interessanten Werkzeug zu tun. Das richtet sich nicht unbedingt an Endanwender, sondern an Unternehmen, die Arbeitsabläufe automatisieren. Das heisst allerdings ..."
...
**rq1.overwhelm.choice_overload**
- `be12019b-f727-4523-9780-fbb7636a4703` (app_store, positive): "As a user without premium, I understand that the service is not going to be as good, but there are way too many ads. Just a year ago, I had only 2-3 ads after a few songs. But now it’s 3-5 ads even after just 2 songs, to where it has genuinely bec..."
- `afe682b2-1df3-44b4-be8e-44a8b9c6a01b` (play_store, negative): "Day by day this app is getting worse.....too many ads for every 3 to 4 songs ....feel like I am using this app to listen songs or ads🤦🏻‍♂️😔 and even ads are of long duration like a minute.I know 1 min is not that long but listening to ads is too m..."
- `f553a8b1-e5a3-4685-824f-ce48faf47cc1` (reddit, neutral): "Is anyone else experiencing glitches on this app? With the induction of AI to the software of Spotify, it’s now too overloaded to properly function as an app consistently. I’ve never experienced more problems with it than this year. Plus they fire..."
...
**rq1.entry_points.clarity**
- `4c1ec6fe-2d4a-47fd-b5f0-5a1f98feaf8e` (mastodon, neutral): "How Do I Heal Evanescence #Evanescence #Goiânia #jannRicardo #música #music #Spotify"
...
- `rq2.control.lack_of_controls` — Lack of control over recommendations (47)
- `rq2.relevance.mismatch` — Recommendations feel irrelevant (31)
- `rq2.repetition.stale` — Recommendations are repetitive / stale (31)
- `rq2.diversity.genre_stagnation` — Genre stagnation / lack of diversity (4)
...
**rq2.relevance.mismatch**
- `b1a68617-49e4-4363-855e-dbb03f692d40` (app_store, positive): "Has any music you can listen to and keeps track on how much you have been listening to that music you love. I was even able to make my own playlists and add my favorite singers on my playlists. I totally recommend downloading Spotify👍👍"
- `06ff2d96-4110-46b8-991a-2dd8810b6f21` (mastodon, positive): "Curated setlist from ⭐Awakenings Festival 2026⭐ — enjoy the ride 🎶 All my playlists &amp; socials: https:// festivalplaylist.com 🎟️ Get your Tickets now: https:// viagogo.prf.hn/click/camref:11 00l4m4k4 # Awakenings_Festival_2026 # fyre_festivals ..."
...
- `f74a6547-b1e9-4c32-9bed-ae63476a6af8` (reddit, negative): "As someone who has used Spotify premium for over a decade, I hate it. Alternatives? I am done. I don’t know what Spotify has done to an app that has been a lifeline for me for music but I am so done. I just went through a breakup and a death in my..."

**rq2.diversity.genre_stagnation**
- `5280e6dc-9a2d-4d8e-b6e5-ec817b852716` (app_store, positive): "I really enjoy this app with all of the unique playlist on here and compared to other apps. There’s just seems to be some more artists. Only complaint is if you’re not on premium version there’s so many ads. It’s really annoying. I’ll just be tryi..."
...
- `8465960c-1fc1-46f6-b884-53fe857b4f98` (app_store, negative): "As an artist, I grieve what this platform is doing. It marginalizes what isn’t already known/popular and provides little musical variety even to those who want it. As a listener, I am disappointed with its narrow and repetitive recommendations (wh..."
...
- `rq3.intent.active_discovery` — Active discovery / novelty seeking (42)
- `rq3.intent.focus_workout` — Focus/workout mood management (35)
- `rq3.intent.background` — Background listening (10)
- `rq3.intent.artist_deep_dive` — Artist deep-dives (6)
...
- `242d8824-ec7d-4a4b-bb74-ab5e25c88c7d` (play_store, positive): "Spotify continues to dominate as the ultimate music and audio platform in 2026. Whether I’m discovering new artists, building playlists for every mood, listening to podcasts, or enjoying audiobooks, it delivers an unbeatable personalized experienc..."
...
- `5521106f-701b-4608-b287-132d5e452153` (reddit, positive): "Spotify makes my phone's audio sound overly deep and bass-heavy — affects YouTube too even after closing Every time I listen to music on Spotify, the sound becomes way too deep or bass-heavy — not just in Spotify, but in other apps like YouTube to..."
...
- `rq4.risk.wasting_time` — Fear of wasting time on bad recs (56)
- `rq4.trust.algorithm_fatigue` — Algorithm fatigue / low trust (16)
- `rq4.habit.comfort_listening` — Comfort listening is intentional (8)
- `rq4.friction.defaulting_to_known` — Friction causes default to known content (7)
...
- `afe682b2-1df3-44b4-be8e-44a8b9c6a01b` (play_store, negative): "Day by day this app is getting worse.....too many ads for every 3 to 4 songs ....feel like I am using this app to listen songs or ads🤦🏻‍♂️😔 and even ads are of long duration like a minute.I know 1 min is not that long but listening to ads is too m..."
- `97efc61a-788a-4fbd-bc15-41648c831c60` (reddit, positive): "Lets be real (subscriptions) Music platforms would make SO MUCH more music giving the choice for DAILY subscriptions. I have 2 SOLID arguments for that. 1 - Unlike movies, gamepass, internet, ect… Music is extremely personal and wide. Music platfo..."
...
- `cb9ab498-f5b1-4722-9651-510a5f5a0c0b` (reddit, positive): "What’s your go-to playlist for instant energy? Looking for playlists that just hit from the first track — the kind of stuff you’d play late at night when the dance floor’s full and no one’s going home yet or in the gym going for pr. Stuff that get..."
...
**rq4.friction.defaulting_to_known**
- `5f6f7d64-894a-4c22-be48-320a204298dc` (app_store, positive): "I’ve been using Spotify for about two years now, and I absolutely love it. I love being able to create my own playlists and discover playlists made by others. The family plan is a huge plus because everyone can have their own account, and I can al..."
...
- `rq5.tier.free_vs_premium` — Free vs Premium constraints (315)
- `rq5.platform.ios` — iOS-specific experience issues (82)
- `rq5.platform.android` — Android-specific experience issues (21)
...
**rq5.tier.free_vs_premium**
- `cb889b8a-ce39-4c6e-95eb-dbfca3c8b8c5` (app_store, negative): "I don’t understand why we still have this disco ball as the apps logo. It’s freaking hideous and an awful way to celebrate your anniversary or whatever the case. I’m honestly about to cancel my subscription, and switch back to Apple Music just so ..."
- `41d6ae3c-4add-42e4-8c5f-aaf86e0057fe` (mastodon, neutral): "🎟️ ¡Atención fans! Spotify lanza en EE.UU. “Reserved”: acceso anticipado a entradas de conciertos para los superfans Premium. Cuánto más escuches a tu artista, más cerca estarás de pillarlas antes que nadie. ¿Llegará pronto a España? 🤞 # Spotify h..."
- `afe682b2-1df3-44b4-be8e-44a8b9c6a01b` (play_store, negative): "Day by day this app is getting worse.....too many ads for every 3 to 4 songs ....feel like I am using this app to listen songs or ads🤦🏻‍♂️😔 and even ads are of long duration like a minute.I know 1 min is not that long but listening to ads is too m..."
...
**rq5.platform.android**
- `ba622c4f-9241-42ff-8dd0-1aee5c594a5d` (mastodon, neutral): "https:// github.com/pooza/capsicum/rele ases/tag/v1.38.0 ◇ 公開状況 公開済み: iOS, Android, Windows, Linux 審査提出済み: macOS ◇ 変更点 ・ナウプレのURL優先プロバイダ https:// github.com/pooza/capsicum/issu es/681 曲名・アーティストなどから曲URLを検索し、ナウプレ（NowPlaying）本文に追記する既存機能がありました。 このURLで優..."
...
- `rq6.unmet.freshness` — Need: fresher discovery surfaces (42)
- `rq6.unmet.transparency` — Need: transparency and explainability (10)
- `rq6.unmet.effortless` — Need: effortless discovery (4)
...
**rq6.unmet.freshness**
- `28deabf7-7c1f-4427-bcc2-020fac39b4e3` (mastodon, positive): "🇺🇦 #NowPlaying on #BBC6Music's #HuwStephensRoundtable Erick the Architect: 🎵 No Doubt (I'm In Love) #6music #EricktheArchitect #newRelease - 🆕 single ▶️ 🆕🪄 Automagic 📻 playlist: 👉 New releases played on #Radio6Music 👈 ▶️ Song on #Spotify: No Doubt..."
- `afe071f3-076c-4c4e-974a-bdda9a3648a4` (play_store, positive): "Spotify is my favourite song listening app. I can find almost any song, album, or playlist I’m looking for, from old classics to new releases. They always introduce me to new music I end up loving. The sound quality is good and I can also download..."
